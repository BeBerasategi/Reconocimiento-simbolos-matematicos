# python3 CNN_MNIST_aug_4layer_400_val.py > log_aug.txt 2> err_aug.txt & 
# DURACIÓN COMPLETA:  01:37:20

# Se utiliza el modelo CNN 4-capas, para entrenar con la base de datos aumentada.

# Se reserva parte del corpus de training como validación.
...
print('DESCRIPTION: CNN training, with data augmentation. Uses validation set. Model: CNN 4 layer')
