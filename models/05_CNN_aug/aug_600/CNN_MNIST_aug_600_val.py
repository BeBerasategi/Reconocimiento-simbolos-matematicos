# python3 CNN_MNIST_aug_600_val.py > log_aug.txt 2> err_aug.txt & 
# DURACIÓN COMPLETA: 

# Se utiliza el modelo más apropiado elegido tras la cv, para entrenar con la base de datos aumentada. 600. Se reserva un set de validación para adaptar mejor la cantidad de epochs.
...
X_train= np.loadtxt("/home/jovyan/work/databases/Data_Augmentation/DA_600/X_aug.csv", delimiter=",")
y_train_id= np.loadtxt("/home/jovyan/work/databases/Data_Augmentation/DA_600/y_aug_id.csv", delimiter=",", dtype=str)
